<?php
class Oa23baseline extends CakeMigration {
	...
	public $migration = array(
		'up' => array(
			'create_table' => array(
				...
				'onlineapp_email_timeline_subjects' => array(
					'id' => array('type' => 'integer', 'null' => false, 'default' => NULL, 'length' => 11, 'key' => 'primary'),
				...
				'onlineapp_users_managers' => array(
		...
		'down' => array(
			'drop_table' => array(
				'equipment_programming', 'merchant', 'onlineapp_apips', 'onlineapp_applications', 'onlineapp_coversheets', 'onlineapp_email_timeline_subjects', 'onlineapp_email_timelines', 'onlineapp_epayments', 'onlineapp_groups', 'onlineapp_settings', 'onlineapp_users', 'onlineapp_users_managers', 'timeline_entries', 'timeline_item'
			),
		),
	);
