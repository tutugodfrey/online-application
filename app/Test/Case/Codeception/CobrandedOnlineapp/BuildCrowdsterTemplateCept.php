...
// authenticate
$I->wantTo("build the default Crowdster template");
$ULP->login();

// start with the cobrand
$cobrandId = $CP->createIfMissing('Crowdster');
...
$fieldId = $FP->createIfMissing('Corporate Status', $sectionId, 12, 0, false, 2, '', 'CorpStatus', 'Non Profit', null, true);
...
$fieldId = $FP->createIfMissing('Website',$sectionId, 12, 17, true, 2, 'http://www.crowdster.com/', 'WebAddress', '', null);
$fieldId = $FP->createIfMissing('Customer Service Phone',$sectionId, 12, 9, true, 2, 'N/A', 'Customer Service Phone', '', null);
...
// create new fields
// $fieldId = $FP->createIfMissing('Location Type', $sectionId, 12, 4, true, 2, 'Retail Store::RetailStore,Industrial::Industrial,Trade::Trade,Office::Office,Residence::Residence,Other::SiteInspectionOther', 'LocationType-', '', null);
...
$fieldId = $FP->createIfMissing('Products/Services Sold', $sectionId, 12, 0, true, 2, 'Non Profit Donations', 'Products Services Sold', '', null);
$fieldId = $FP->createIfMissing('Return Policy', $sectionId, 12, 0, true, 2, 'upon request', 'Return Policy', '', null);
$fieldId = $FP->createIfMissing('Days Until Product Delivery', $sectionId, 12, 0, true, 2, 'varies', 'Days Until Product Delivery', '', null);
...
$fieldId = $FP->createIfMissing('Current Processor', $sectionId, 12, 0, true, 2, 'N/A', 'Previous Processor', '', null);
...
$fieldId = $FP->createIfMissing('Where is inventory housed?', $sectionId, 12, 0, true, 2, 'N/A', 'Where is inventory housed', '', null);
...
$fieldId = $FP->createIfMissing('Customer Service (Desc)', $sectionId, 4, 0, true, 2, 'no', 'Customer Service', '', null);
$fieldId = $FP->createIfMissing('Product Shipment (Desc)', $sectionId, 4, 0, true, 2, 'no', 'Product Shipment', '', null);
$fieldId = $FP->createIfMissing('Handling of Returns (Desc)', $sectionId, 4, 0, true, 2, 'no', 'Handling of Returns', '', null);
$fieldId = $FP->createIfMissing('Cardholder Billing', $sectionId, 12, 0, true, 0, 'no', 'Cardholder Billing', '', null);
$fieldId = $FP->createIfMissing('By what methods do sales take place? (i.e. internet, trade shows, etc.)', $sectionId, 12, 0, true, 2, 'internet', 'By what methods to sales take place ie Internet trade shows etc ', '', null);
...
$fieldId = $FP->createIfMissing('Nationally', $sectionId, 6, 3, false, 2, 'true', 'nationally', '', null);
...
$fieldId = $FP->createIfMissing('Monthly', $sectionId, 3, 3, false, 2, 'true', 'Monthly Recurring', '', null);
...
$fieldId = $FP->createIfMissing('% FULL PAYMENT UP FRONT WITH', $sectionId, 6, 11, false, 2, '100', 'PercentFullPayUpFront', '', null);
...
// create new fields
$fieldId = $FP->createIfMissing('Quantity', $sectionId, 3, 19, true, 2, '1', 'QTY1', '', null);
$fieldId = $FP->createIfMissing('Type', $sectionId, 3, 0, true, 2, 'Axia E PAY', 'Terminal1', '', null);
...
$fieldId = $FP->createIfMissing('If Yes, What Time?', $sectionId, 6, 2, false, 2, '10 pm', 'Autoclose Time 1', '', null);
...
$fieldId = $FP->createIfMissing('AVS', $sectionId, 2, 3, false, 2, 'true', 'AVS', '', null);
