...
$fieldId = $FP->createIfMissing('Customer Service (Desc)', $sectionId, 4, 0, false, 2, 'no', 'Customer Service', '', null);
$fieldId = $FP->createIfMissing('Product Shipment (Desc)', $sectionId, 4, 0, false, 2, 'no', 'Product Shipment', '', null);
$fieldId = $FP->createIfMissing('Handling of Returns (Desc)', $sectionId, 4, 0, false, 2, 'no', 'Handling of Returns', '', null);
