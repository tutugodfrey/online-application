...
$fieldId = $FP->createIfMissing('By what methods do sales take place? (i.e. internet, trade shows, etc.)', $sectionId, 12, 0, true, 2, 'internet', 'By what methods do sales take place ie internet trade shows etc', '', null);
