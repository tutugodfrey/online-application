...
my $templateMap = {
    'General Information' => {
        'OWNERSHIP TYPE' => [
            "'Ownership Type', \$sectionId, 6, 4, true, 2, 'Corporation::Corp,Sole Prop::SoleProp,LLC::LLC,Partnership::Partnership,Non Profit/Tax Exempt (fed form 501C)::NonProfit,Other::Other', 'OwnerType-', '', null",
