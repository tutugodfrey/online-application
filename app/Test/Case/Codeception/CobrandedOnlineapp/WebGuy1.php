...
class WebGuy1 extends \Codeception\AbstractGuy
{
    ...
    * Conditional Assertion: Test won't be stopped on fail
     ...
     *
    * Conditional Assertion: Test won't be stopped on fail
     * @see Codeception\Module\WebHelper::seeCobrandForm()
     * @return \Codeception\Maybe
     */
    public function canSeeCobrandForm() {
        $this->scenario->addStep(new \Codeception\Step\ConditionalAssertion('seeCobrandForm', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    public function seeCobrandForm() {
        $this->scenario->addStep(new \Codeception\Step\Assertion('seeCobrandForm', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
