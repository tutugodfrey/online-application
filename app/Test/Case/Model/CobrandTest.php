...
class CobrandTest extends CakeTestCase {
	...
	public function testValidation() {
		...
		$this->assertFalse($this->Cobrand->validates());
		$this->assertEquals($expected_misth_short, $this->Cobrand->validationErrors);

		// add partner_name_short but no partner_name
		$expected_missing_name = array(
			'partner_name' => array('Partner name cannot be empty')
		);
		$this->Cobrand->create(array(
			'partner_name' => '',
		...
		$this->assertFalse($this->Cobrand->validates());
		$this->assertEquals($expected_missing_name, $this->Cobrand->validationErrors);
