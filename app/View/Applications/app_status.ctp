...
<div id="dashboard_object_details">
 <div id="object_details_meat">   
     <h3 style="text-align:center;"> <?php echo 'Document Status: ' . ucfirst($data['document']['state']); ?><?php echo (ucfirst($data['document']['state'] == 'expired')) ? ' ' . $this->Html->link('Extend Application 7 days', 'app_status/' . $id . '/' . $guid):''; ?></h3>
