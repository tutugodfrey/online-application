    ...
    <tr>
        <td>
            <?php echo $this->Html->div(
                ...
                $this->Form->text('monthly_volume', array('onblur' => '$(this).val($(this).val().replace(/,/g, \'\'))'))
            ); ?>
        </td>
        <td>
            <?php echo $this->Html->div(
                ...
                $this->Form->text('average_ticket', array('onblur' => '$(this).val($(this).val().replace(/,/g, \'\'))'))
            ); ?>
        </td>
        <td>
            <?php echo $this->Html->div(
                ...
                $this->Form->text('highest_ticket', array('onblur' => '$(this).val($(this).val().replace(/,/g, \'\'))'))
            ); ?>
        </td>
    </tr>
</table>
...
<div id="moto_and_internet">
    ...
    <div style="clear: left;">&nbsp;</div>
    <p>Please explain your billing/delivery policy and to what percentage each applies. Total must equal 100%: *</p>
