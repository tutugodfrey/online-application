...
<body>
	...
	<div class="container">
		...
		<div class="span-24">
			...
			if ($error) {
				if ($alreadySigned) {
                                        if($data['Application']['api'] == '0') {
					echo "<h3>Document is Signed</h3><div class=\"span-24\">";
					echo "All Signers have Successfully Signed. <br/>";
                                        }
                                        if($data['Application']['api'] == '1' && $data['Application']['user_id'] = '59') {
                                        echo "<br />All signers have successfully signed.  Thank you for completing the application and signing. Here is what to do next:<br/>";
                                        echo "<br />";
                                        echo "Fax (877.875.5135) or Email <a href=\"mailto:hooza@axiapayments.com?Subject=" . $data['Application']['dba_business_name'] . "%20Hooza%20Application\">hooza@axiapayments.com</a> the following documents to Axia.<br/>";
                                        echo "<br />";
                                        echo "Document 1. Voided Check<br/>";
                                        echo "Document 2. Business License<br/>";
                                        echo "Document 3. Drivers License<br/>";
                                        echo "<br />";
                                        echo "Once these have been received we will complete the set up and you will receive notification and instructions on how to begin accepting payments on your Hooza website. <br />";
                                        echo "<br />";
                                        echo "<a href=\"http://www.hooza.co\">Back To Hooza</a><br/>"; 
                                        }
					echo "</div>";
				} else {
