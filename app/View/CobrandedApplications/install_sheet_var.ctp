...
<?php
    ...
    if ($data['Merchant']['merchant_id'] == ""){
        ...
        if ($data['CobrandedApplication']['rightsignature_install_status'] == 'sent') {
            ...
            echo $this->Html->link('Click to Send Again.', '', array('update' => $div_string, 'loading' => 'Effect.Appear(\''.$div_string.'\')',)) . '<br/>';
            echo $this->Html->div($div_string, array('style' => 'display:none'));
        }
