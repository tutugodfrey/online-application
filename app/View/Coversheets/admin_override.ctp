				...
				<?php 
					echo $this->Form->create('Coversheet', array(
							'inputDefaults' => array(
								...
								'label' => array('class' => 'col-md-6 control-label'),
								'wrapInput' => 'col-md-5',
								'class' => 'form-control input-sm',
							),
							'class' => 'form-horizontal',
						));
					echo $this->Html->tag('div', '<strong>Rep Name:</strong> '. $data['User']['fullname'], array('class' => 'col-md-offset-1'));
					echo $this->Form->hidden('id', array('value' => Hash::get($data, 'Coversheet.id')));
