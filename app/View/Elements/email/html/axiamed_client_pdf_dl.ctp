<div style="margin-bottom: 20px;background-color: #f5f5f5;border: 1px solid #ddd;padding: 35px;">
	<div style="margin-bottom: 20px;background-color: #fff;border: 1px solid;border-color: #bce8f1;">
		...
		<div style="margin: 50px 50px 50px 50px;">
	        ...
	        <p>The copy you requested of the executed agreement and/or document <?php echo (!empty($merchantDBA))? "for $merchantDBA" :''; ?> is ready to be downloaded using the link below.</p>
			<p><strong> Please be advised that for your security this download link should not be shared with anyone, since the document may contain confidential information. In addition, this link will expire within 24 hours from now.</strong></p>
			<div style="text-align: center;">
				<div style="margin: 0 auto; text-align: center;">
					<?php
						echo "<a href='$appPdfUrl'><img width='100' height='100' src='https://app.axiatech.com/img/pdf-axiamed-dl.png'>";
						echo "<br/><strong>Download</strong></a>";
					?>	
				</div><br/>
			</div>
			<p>Thank you for choosing us and allowing us to expand the payment options available to your patients and/or clients with our best-in-class payments solutions!<br/>
