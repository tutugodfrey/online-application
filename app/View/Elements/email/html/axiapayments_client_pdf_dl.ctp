		...
		<div style="margin: 50px 50px 50px 50px;">
			...
			<div style="text-align: center;">
				<div style="margin: 0 auto; text-align: center;">
					<?php echo "<a href='$appPdfUrl'><img width='100' height='100' src='https://app.axiatech.com/img/pdf-dl.png'><br><strong>Download</strong></a>"; ?>
				</div><br>
			</div>
			<p>Thank you for choosing us and allowing us to expand the payment options available to your clients!<br/>
