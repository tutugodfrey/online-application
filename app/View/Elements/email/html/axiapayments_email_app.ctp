<div style="margin-bottom: 20px;background-color: #f5f5f5;border: 1px solid #ddd;padding: 35px;">
	<div style="margin-bottom: 20px;background-color: #fff;border: 1px solid;border-color: #bce8f1;">
		...
		<div style="margin: 50px 50px 50px 50px;">
	        <p>Dear <?php echo $ownerName; ?><br/>DBA: <?php echo $merchantDBA; ?></p>
	        <p>Please click on the following link to complete your Axia Payments Application:</p>
			<p><strong> For your security, do not share this link with anyone since it may contain confidential information.</strong></p>
