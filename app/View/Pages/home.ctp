...
<div class="center">
    ...
    <!-- &nbsp; &nbsp; -->
    <?php echo $this->Html->link($this->Html->image('retrieve_existing_applications.png', array('alt' => 'Retrieve Existing Applications', 'border' => '0')), array('controller' => 'applications', 'action' => 'retrieve'), array('escape' => false)); ?>
</div>
